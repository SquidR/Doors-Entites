...
local entityTable = Spawner.createEntity({
    ...
    CustomDialog = {"You have died to Blitz", "They are docile until they scream.", "When you hear the scream, hide!"} -- Custom death message
})
...
entityTable.Debug.OnLookAwayFromEntity = function()
end
